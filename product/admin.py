...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Display Options", {"fields": ("icon", "order", "is_active")}),
        (
            "Timestamps",
...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            "Basic Information",
            {"fields": ("name", "slug", "sku", "category", "brand", "manufacturer")},
        ),
        (
            "Description",
            {
        ...
        ("Images", {"fields": ("main_image", "thumbnail_image")}),
        (
            "Status & Metadata",
            {
                "fields": (
...
class ProductDocAdmin(admin.ModelAdmin):
    ...
    list_filter = ["doc_type", "is_public", "uploaded_at"]
    ...
    fieldsets = (
        (
            ...
            {"fields": ("product", "title", "doc_type", "description")},
        ),
        (
            "File Details",
            {"fields": ("file", "file_size_mb", "file_extension", "is_public")},
        ),
        (
            "Statistics",
            {"fields": ("download_count", "uploaded_by", "uploaded_at", "updated_at")},
        ),
    )
...
class InventoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status & Condition", {"fields": ("status", "condition", "current_location")}),
        (
        ...
        (
            "Sales Information",
            {
                "fields": ("customer", "sale_date", "sale_price", "profit_margin"),
                "classes": ("collapse",),
            },
        ),
        (
            "Assignment",
            {"fields": ("assigned_to", "assigned_date"), "classes": ("collapse",)},
        ),
        (
            "Service & Maintenance",
            {
                "fields": ("last_service_date", "next_service_date", "service_history"),
                "classes": ("collapse",),
            },
        ),
        (
    ...
    def warranty_status_display(self, obj):
        if obj.warranty_status == "active":
            ...
            if days <= 30:
                return format_html(
                    '<span style="color: orange;">Active ({} days left)</span>', days
                )
            return format_html(
                '<span style="color: green;">Active ({} days left)</span>', days
            )
    ...
    def update_warranty_status_action(self, request, queryset):
        ...
        self.message_user(
            request, f"Updated warranty status for {queryset.count()} items."
        )
...
class ProductOptionNameAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Option Information", {"fields": ("name", "description", "is_active")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ProductOptionItemAdmin(admin.ModelAdmin):
    ...
    list_display = ["value", "option_name", "ordering", "is_active", "created_at"]
    list_filter = ["option_name", "is_active", "created_at"]
    search_fields = ["value", "option_name__name"]
    ordering = ["option_name", "ordering", "value"]

    fieldsets = (
        (
            "Option Item Information",
            {"fields": ("option_name", "value", "ordering", "is_active")},
        ),
